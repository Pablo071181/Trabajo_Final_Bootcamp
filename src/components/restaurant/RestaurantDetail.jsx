...
const RestaurantDetail = ({ Restaurant }) => {
  const { genres, homepage, original_language, original_title, overview, poster_path, release_date, runtime } = Restaurant;
  return (
    <>
      ...
      <section className="section">
        <div className="container">
          <div className="card card--Restaurant">
            <div className="card__body card__body--Restaurant">
              <img
